...
window.LMS_CONFIG = {
  ...
  password: 'TIEUM_Learning0421',   // 수강 비밀번호 (변경 가능)
...
window.LMS_COURSES = [
  ...
  ══════════════════════════════════════════════════ */
  {
    ...
    duration: '4주 · 12강',
    color:    '#1b4f8a',
    instructor: { name: '최주안', role: '티움 사무국장' },
  ...
  ══════════════════════════════════════════════════ */
  {
    ...
    duration: '3주 · 9강',
    color:    '#553c9a',
    instructor: { name: '티움 연구팀', role: '교육 연구팀' },
  ...
  ══════════════════════════════════════════════════ */
  {
    ...
    subtitle: 'Talent · Mindset · Dedication — 미래 리더 훈련',
    subtitle_en: 'Talent · Mindset · Dedication — Training Future Leaders',
    category: 'leadership',
    level:    'intermediate',
    duration: '3주 · 9강',
    color:    '#2c7a7b',
    instructor: { name: '최주안', role: '티움 사무국장' },
    description: '티움의 핵심 교육 철학인 TMD(Talent·Mindset·Dedication)를 기반으로 한 리더십 훈련 과정입니다. 역량 발굴, 성장 마인드셋, 헌신과 실천을 균형 있게 개발합니다.',
    description_en: 'A leadership training program based on TIEUM\'s core educational philosophy of TMD (Talent · Mindset · Dedication). Develop talent discovery, growth mindset, and dedication in balance.',
    ...
    modules: [
      ...
      {
        id: 'm2', title: '2주차: Mindset — 성장 마인드셋', title_en: 'Week 2: Mindset — Growth Mindset',
        lessons: [
          ...
          { id: 'l6',  title: 'Mindset 적용 사례 연구', title_en: 'Mindset Application Case Study',                 type: 'video', duration: '20분', videoId: '', videoType: 'drive' },
        ],
      },
      {
        id: 'm3', title: '3주차: Dedication — 헌신과 실천', title_en: 'Week 3: Dedication — Commitment & Practice',
        lessons: [
          { id: 'l7',  title: '헌신과 실천이란 무엇인가', title_en: 'What is Commitment and Practice?',            type: 'video', duration: '24분', videoId: '', videoType: 'drive' },
          { id: 'l8',  title: '일상에서 헌신 실천하기', title_en: 'Practicing Dedication in Daily Life',              type: 'video', duration: '32분', videoId: '', videoType: 'drive' },
          { id: 'l9',  title: 'TMD 종합 퀴즈 & 수료', title_en: 'TMD Comprehensive Quiz & Completion',               type: 'quiz',  duration: '15분', quiz: [
            { q: 'TMD에서 D(Dedication)의 핵심 가치는?',
              options: ['부의 축적', '헌신과 실천으로 인류 사회에 기여', '지식의 양', '권력'],
              answer: 1 },
            { q: '티움의 교육 목표인 TMD 인재는?',
              options: ['학업 성취만 높은 인재', 'T·M·D를 균형 있게 갖춘 인재', '경쟁에서 이기는 인재', '부자가 되는 인재'],
              answer: 1 },
            { q: 'TMD에서 M(Mindset)이 상징하는 것은?',
              options: ['단순 지식', '주어진 자원을 잘 관리하는 성장 마인드셋', '경쟁', '외모'],
              answer: 1 },
          ]},
        ],
      },
