...
(function () {
  ...
  const T = {
    ko: {
      ...
      'tmd.m.label': '공평한 기회',
      'tmd.m.p':     '누구에게나 동일하게 주어진 기회와 가능성을 발견하고 실현하는 인재',
      'tmd.d.label': '섬김의 성품',
      'tmd.d.p':     '자신이 가진 것을 이웃과 나누며 섬기는 성품을 갖춘 인재',
      ...
      'greeting.subrole':   '㈜TMD 교육그룹 대표',
      'greeting.tag1':      '#자기주도학습',
      'greeting.tag2':      '#진로교육전문가',
      'greeting.tag3':      '#플래닝',
      'greeting.c1':        '前 EBS 「60분 부모」 부모특강 강사',
      'greeting.c2':        '1999 조선일보 선정 \'밀레니엄 리더 21인\'',
      'greeting.c3':        '2020 중소벤처기업부 \'존경받는 기업인\' 선정',
      'greeting.books':     '<span class="books-label">대표 저서</span> 『공부감성』 『꿈의 교실』 『소리치지 않고 화내지 않고 초등학생 공부시키기』 외 다수',
      ...
      'testi.1.p':   'AI는 동료다. 피하지 않고 함께 가기.',
      'testi.1.name':'수다방 참가자', 'testi.1.role':'TIEUM AI 수다방 제1회',
      'testi.2.p':   '누구나 됩니다. 새 세상의 문 안에 들어왔다.',
      'testi.2.name':'수다방 참가자', 'testi.2.role':'TIEUM AI 수다방 제1회',
      'testi.3.p':   '편안한 분위기와 소통. 편안하고 유익한 시간이었습니다.',
      'testi.3.name':'수다방 참가자', 'testi.3.role':'TIEUM AI 수다방 제1회',
      'testi.4.p':   '혼자였다면 절대 도달하지 못했을 시야의 확장을 선물해 준 가장 실질적인 프로그램이었습니다.',
      'testi.4.name':'1기 수료생', 'testi.4.role':'제1기 미래아카데미',
      'testi.5.p':   '전공에 갇혀 있었는데, 다학제적인 시각으로 세상을 바라보게 되었습니다.',
      'testi.5.name':'1기 수료생', 'testi.5.role':'제1기 미래아카데미',
      'testi.6.p':   '토요일의 황금시간을 반납하는 것이 쉽지는 않았지만, 그 시간을 통해 오히려 제 인생의 황금 같은 시간을 얻게 된 것 같습니다.',
      'testi.6.name':'박신애', 'testi.6.role':'제1기 미래아카데미 수료생',
      'testi.7.p':   '표현하지 않은 마음은 알 수 없습니다. 행동하지 않으면 당신의 가능성을 알 수 없습니다.',
      'testi.7.name':'곽동우', 'testi.7.role':'제1기 미래아카데미 수료생',
      'testi.8.p':   '리더라면 무조건 포용하고 듣는 것이 아니라, 때로는 기준을 확고하게 지키는 역할도 해야 팀이 산으로 가지 않는다는 것을 배웠습니다.',
      'testi.8.name':'박태환', 'testi.8.role':'제1기 미래아카데미 수료생',
      'testi.9.p':   '다양한 사람들과 이야기를 나누며 앞으로 다가올 시대를 새로운 시각으로 바라볼 수 있었습니다.',
      'testi.9.name':'엄주은', 'testi.9.role':'제1기 미래아카데미 수료생',
    ...
    en: {
      ...
      'greeting.subrole':   'CEO, TMD Education Group',
      'greeting.tag1':      '#Self-DirectedLearning',
      'greeting.tag2':      '#CareerEducation',
      'greeting.tag3':      '#Planning',
      'greeting.c1':        'Former Parenting Lecturer, EBS \'60-Minute Parents\'',
      'greeting.c2':        '1999 \'21 Millennium Leaders\' — Chosun Ilbo',
      'greeting.c3':        '2020 Most Admired CEO — Ministry of SMEs & Startups',
      'greeting.books':     '<span class="books-label">Books</span> <em>Study Sensibility</em>, <em>Dream Classroom</em>, <em>Teaching Your Child Without Yelling</em> & more',
      ...
      'testi.1.p':   'AI is a colleague. Going together, not running away.',
      'testi.1.name':'Workshop participant', 'testi.1.role':'1st TIEUM AI Talk',
      'testi.2.p':   'Anyone can do it. I have stepped through the door into a new world.',
      'testi.2.name':'Workshop participant', 'testi.2.role':'1st TIEUM AI Talk',
      'testi.3.p':   'A relaxed atmosphere and real conversation. It was a comfortable and useful time.',
      'testi.3.name':'Workshop participant', 'testi.3.role':'1st TIEUM AI Talk',
      'testi.4.p':   'It was the most practical program I have taken — it gave me a widening of perspective I could never have reached alone.',
      'testi.4.name':'1st cohort graduate', 'testi.4.role':'1st Future Academy',
      'testi.5.p':   'I had been confined to my own major. Now I see the world through a multidisciplinary lens.',
      'testi.5.name':'1st cohort graduate', 'testi.5.role':'1st Future Academy',
      'testi.6.p':   'Giving up my Saturdays was not easy, but through that time I think I gained golden hours for my life instead.',
      'testi.6.name':'Park Shin-ae', 'testi.6.role':'Graduate, 1st Future Academy',
      'testi.7.p':   'A heart left unexpressed cannot be known. Without action, you cannot know your own potential.',
      'testi.7.name':'Kwak Dong-woo', 'testi.7.role':'Graduate, 1st Future Academy',
      'testi.8.p':   'I learned that a leader does not simply accept and listen to everything — sometimes holding firm to a standard is what keeps the team on course.',
      'testi.8.name':'Park Tae-hwan', 'testi.8.role':'Graduate, 1st Future Academy',
      'testi.9.p':   'Talking with all kinds of people let me look at the era ahead of us with fresh eyes.',
      'testi.9.name':'Eom Ju-eun', 'testi.9.role':'Graduate, 1st Future Academy',
      ...
      'lms.login.title': 'TIEUM Learning Center', 'lms.login.desc': 'Just enter your name and email to start for free.',
