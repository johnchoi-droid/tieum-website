...
(function () {
  ...
  const T = {
    ko: {
      ...
      'greeting.tag3':      '#플래닝',
      'greeting.c1':        '前 EBS \'부모광장\' 메인 패널',
      'greeting.c2':        '前 조선일보 선정 교육전문가 1호',
      'greeting.c3':        '前 한국교육개발원(KEDI) 자문위원',
      'greeting.c4':        '2020 중소벤처기업부 \'존경받는 기업인\' 선정',
      'greeting.books':     '<span class="books-label">대표 저서</span> 『공부감성』 『꿈의교실』 『진로교육론』 외 다수',
    ...
    en: {
      ...
      'greeting.c1':        'Former Main Panelist, EBS \'Parents\' Square\'',
      'greeting.c2':        'Former No.1 Education Expert, Chosun Ilbo',
      'greeting.c3':        'Former Advisory Member, KEDI',
      'greeting.c4':        '2020 Most Admired CEO — Ministry of SMEs & Startups',
      'greeting.books':     '<span class="books-label">Books</span> <em>Study Sensibility</em>, <em>Dream Classroom</em>, <em>Career Education Theory</em> & more',
