...
(function () {
  ...
  const T = {
    ko: {
      ...
      'loc.bus':   '버스',
      'loc.car':   '자가용',
      'loc.sub.p': '서울 지하철 2호선 <strong>방배역</strong> 1번 출구에서 도보 5분',
      'loc.bus.p': '효령로 방면 정류장 하차',
    ...
    en: {
      ...
      'team.desc':  'Meet the Chairman, Directors, Secretary-General and Advisory Committee members leading TIEUM\'s work',
      'team.g1':    'Chairman',
      'team.g2':    'Directors',
      'team.g3':    'Secretary-General',
      ...
      'loc.bus':   'Bus',
      'loc.car':   'By Car',
      'loc.sub.p': 'Seoul Metro Line 2 — <strong>Bangbae Station</strong>, Exit 1 (5-min walk)',
      'loc.bus.p': 'Get off at Hyoryeong-ro stop',
      ...
      'team.sg.badge':        'Ed.D.',
      'about.sg.title':       'Secretary-General, TIEUM Nonprofit Foundation',
      ...
      'about.greeting.closing':'Sincerely, Dr. Juan Choi — Secretary-General, TIEUM Nonprofit Foundation',
